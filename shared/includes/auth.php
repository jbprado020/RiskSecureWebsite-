...
function requireCustomerLogin(): void
{
    ...
    if (!isCustomerLoggedIn()) {
        // Use a relative path that works from customer/ and customer/auth/
        // A better approach is to use a root-relative path if we know the project root.
        // For now, let's use a path that assumes we are in the silo or one level deep.
